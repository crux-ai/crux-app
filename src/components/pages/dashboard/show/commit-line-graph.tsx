...
import { type ChartData, customDateFormatter, type Frequencies, groupByDate } from '@/lib/git/transformations';
  ...
  useEffect(() => {
    const handleLoad = async () => {
      if (commitData) {
        ...
        setChartData(groupedCommits);
        setIsLoading(false);
        return;
      }
      toast.error('No Data was given to this element');
      setFailedLoad(true);
      setIsLoading(false);
    };
    handleLoad();
